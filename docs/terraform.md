...
| <a name="input_create_origin_bucket"></a> [create\_origin\_bucket](#input\_create\_origin\_bucket) | If true, create an origin bucket. If you set this to false, you must supply one with var.origin\_bucket | `bool` | `true` | no |
...
| <a name="input_origin_bucket"></a> [origin\_bucket](#input\_origin\_bucket) | If var.create\_origin\_bucket is false, this is required to specify the origin bucket name. If var.create\_origin\_bucket is true, you can optionally set this to override the automatically generated name. | `string` | `null` | no |
