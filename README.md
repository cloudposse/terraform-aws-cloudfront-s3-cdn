...
| <a name="input_default_origin_id"></a> [default\_origin\_id](#input\_default\_origin\_id) | If set to true, will override the default origin group of the Cloudfront distribution. If not set, the value will be set to the origin created by this module. | `string` | `null` | no |
