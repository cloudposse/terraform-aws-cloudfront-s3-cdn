...
resource "aws_cloudfront_distribution" "default" {
  ...
  dynamic "origin_group" {
    ...
    content {
      origin_id = origin_group.value.group_id != null ? origin_group.value.group_id : "${module.this.id}-group[${origin_group.key}]"
  ...
  default_cache_behavior {
    ...
    target_origin_id           = var.default_origin_id != null ? var.default_origin_id : local.origin_id
